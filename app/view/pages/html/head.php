...
$meta_siteURL="https://" . $_SERVER['HTTP_HOST'] . parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH);
...
<head>
      ...
      <link href="/assets/img/logo/logo_icon.svg" rel="icon">
      <link href="/assets/img/logo/logo_icon.svg" rel="apple-touch-icon">
